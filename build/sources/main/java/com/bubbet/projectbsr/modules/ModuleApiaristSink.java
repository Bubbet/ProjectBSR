...
public class ModuleApiaristSink extends LogisticsModule {
    ...
    public void registerPosition(ModulePositionType slot, int positionInt) {
        ...
        _sinkReply = new SinkReply(SinkReply.FixedPriority.EnchantmentItemSink, 0, true, false, 1, 0, new PipeLogisticsChassi.ChassiTargetInformation(getPositionInt()));
    }
