package com.bubbet.projectbsr.gui.modules;
...
public class GuiApiaristSink extends ModuleBaseGui {
        ...
        private static final String PREFIX = "gui.apiaristsink.";
        private static final ResourceLocation TEXTURE = new ResourceLocation("projectbsr", "textures/gui/apiaristsink.png");

        private final ModuleApiaristSink _apiaristSink;
        private final boolean isFuzzy;
        private int fuzzyPanelSelection = -1;

        public GuiApiaristSink(IInventory playerInventory, ModuleApiaristSink apiaristSink, boolean hasFuzzyUpgrade) {
                super(null, apiaristSink);

                isFuzzy = hasFuzzyUpgrade;
                _apiaristSink = apiaristSink;
                //DummyContainer dummy = new DummyContainer(playerInventory, _apiaristSink.getFilterInventory());
...
/*
        public GuiApiaristSink(Container par1Container, LogisticsGuiModule module) {
                super(par1Container, module);
        }
