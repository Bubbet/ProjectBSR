package com.bubbet.projectbsr.modules;

import com.bubbet.projectbsr.network.guis.module.inhand.ApiaristSinkInHand;
import com.bubbet.projectbsr.network.guis.module.inpipe.ApiaristSinkSlot;
...
public class ModuleApiaristSink extends LogisticsGuiModule {
    ...
    public ModuleCoordinatesGuiProvider getPipeGuiProvider() {
        return NewGuiHandler.getGui(ApiaristSinkSlot.class);
    }

    @Override
    protected ModuleInHandGuiProvider getInHandGuiProvider() {
        return NewGuiHandler.getGui(ApiaristSinkInHand.class);
    }
    ...
    public void registerPosition(ModulePositionType slot, int positionInt) {
        ...
        _sinkReply = new SinkReply(SinkReply.FixedPriority.EnchantmentItemSink, 0, true, false, 2, 0, new PipeLogisticsChassi.ChassiTargetInformation(getPositionInt()));
    }

    @Override
    public SinkReply sinksItem(ItemIdentifier itemID, int bestPriority, int bestCustomPriority, boolean allowDefault, boolean includeInTransit, boolean b2) {
